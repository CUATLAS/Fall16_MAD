...
public class MainActivity extends AppCompatActivity {
    ...
    public void findMood(View view) {
        ...
        //imageview
        ImageView feelingImage = (ImageView) findViewById(R.id.imageView);

        //set the image based on the spinner value
        switch(moodValue){
            case "happy":
                feelingImage.setImageResource(R.drawable.feeling1);
                break;
            case "sad":
                feelingImage.setImageResource(R.drawable.feeling2);
                break;
            case "confused":
                feelingImage.setImageResource(R.drawable.feeling3);
                break;
            case "angry":
                feelingImage.setImageResource(R.drawable.feeling4);
                break;
            default:
                break;
        }
/*
        //this also sets the image using if/else statements
